      ...
      <div className="mx-auto max-w-2xl">
        {products.map((product) => (
          <div key={product.id} className="-mt-2 mx-auto p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-white py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16" onMouseOver={() => form.setValue("productId", product.id)}>
              <div className="mx-auto max-w-xs px-8">
                ...
                <div className="mt-10">
                  <SubmitButton text="Choose" form={form} onPress={handleCreatePaymentIntent} />
                </div>
